      ...
      <div className="p-4 flex-1">
        ...
        <div className="flex items-end justify-center gap-4 mb-8">
          ...
          <div className="flex flex-col items-center -mt-4">
            ...
            <div className="bg-gold/15 rounded-t-xl px-6 py-8 mt-2 text-center border-t border-l border-r border-gold/30 glow-gold" style={{ height: '100px' }}>
        ...
        {/* Your Result */}
        {isWinner && (
          <div className="card-highlight text-center mb-6">
